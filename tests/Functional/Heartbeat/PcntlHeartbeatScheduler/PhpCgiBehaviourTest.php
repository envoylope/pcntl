...
namespace Envoylope\Pcntl\Tests\Functional\Heartbeat\PcntlHeartbeatScheduler;
 ...
 *
 * Checks the behaviour of PcntlHeartbeatScheduler with php-cgi as the SAPI host process.
 *
 * TODO: Refactor to use asmblah/fast-cgi instead.
 *
